/*
	...
	下面是创建用户zyq1_user
	CREATE USER ZYQ1_USER IDENTIFIED BY 123
	DEFAULT TABLESPACE "USERS"
	TEMPORARY TABLESPACE "TEMP";
	
	-- QUOTAS
	ALTER USER ZYQ1_USER QUOTA UNLIMITED ON USERS;
	ALTER USER ZYQ1_USER QUOTA UNLIMITED ON USERS02;
	ALTER USER ZYQ1_USER ACCOUNT UNLOCK;
	
	-- ROLES
	GRANT "CONNECT" TO ZYQ1_USER WITH ADMIN OPTION;
	GRANT "RESOURCE" TO ZYQ1_USER WITH ADMIN OPTION;
	ALTER USER ZYQ1_USER DEFAULT ROLE "CONNECT","RESOURCE";
	
	-- SYSTEM PRIVILEGES
	GRANT CREATE VIEW TO ZYQ1_USER WITH ADMIN OPTION;
