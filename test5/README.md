...
```
效果如图：<br>
![](https://github.com/ZYQHZ/ORACLE/blob/master/test5/1.PNG)<br>
...
```
效果如图：<br>
![](https://github.com/ZYQHZ/ORACLE/blob/master/test5/2.PNG)<br>
...
```
效果如图：<br>
![](https://github.com/ZYQHZ/ORACLE/blob/master/test5/3.PNG)<br>
5.由于订单只是按日期分区的，上述统计是全表搜索，因此统计速度会比较慢，如何提高统计的速度呢？<br>
用索引提高效率;分区技术。
